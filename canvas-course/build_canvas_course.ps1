...
'@;
  ...
  [ordered]@{
    ...
    Lede='The District Kickoff is separate from the six Stauffer project workdays. The two additional Monday workdays remain subject to school and CTE approval.';
    Content=@'
