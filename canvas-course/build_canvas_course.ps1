...
'@;
    Links=@(@{Label='Open the full kickoff prototype and mentor plan';Url="$baseUrl/mentor-lesson-plans.html#kickoff-badge"},@{Label='Open lunch checkpoints';Url="$baseUrl/lunch-checkpoints.html"},@{Label='Open the roadmap';Url="$baseUrl/program-roadmap.html"})
  },
  [ordered]@{
