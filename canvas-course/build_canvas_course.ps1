...
<div style="padding:20px;border:1px solid #ded8f7;border-radius:14px;margin-bottom:18px;">
  ...
  <ul><li>Up to 50 Femineers work through six project phases using five full pull-out workdays, three all-program Wednesday lunch checkpoints, and one invitation-only Project Rescue lunch.</li><li>Full workdays meet in Room 14 on the Monday bell schedule, 8:00 a.m.–2:41 p.m.</li><li>All-program lunch checkpoints meet in Room 14 from 12:29–12:59 p.m. on October 21, January 13, and February 10. December 2 is an invitation-only evidence conference for projects needing a decision before December 7.</li><li>Students must check with teachers, collect assignments and notes, and complete all classwork missed during pull-out workdays by each teacher’s deadline.</li><li>Tri Tansopalucks, Jennifer Frausto, and Stephanie Chavez are the three primary teacher mentors.</li><li>Use your iPad for Canvas, evidence, and BirdBlox. Classroom Windows laptops support MakeCode and micro:bit preparation.</li></ul>
</div>
