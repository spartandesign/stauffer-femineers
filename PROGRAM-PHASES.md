...
|---|---|---|---|---|---|---|
| 1 | Monday, September 21, 2026 | Imagine the Future | Learn, explore, brainstorm, design, and gain approval | Explore sewable LEDs, conductive thread, micro:bit, and NeoPixels; design both individual wearables | Form teams of two; explore Hummingbird inputs and outputs; design a future invention | Checkpoint 1: approved project proposal |
