...
|---|---|---|---|---|---|---|
| 1 | Monday, September 21, 2026 | Imagine the Future | Confirm year-based placement, learn, explore, brainstorm, design, and gain approval | Second- and third-year Femineers explore sewable LEDs, conductive thread, micro:bit, and NeoPixels; design both individual wearables | First-year Femineers form teams of two; explore Hummingbird inputs and outputs; design a future invention | Checkpoint 1: approved project proposal |
